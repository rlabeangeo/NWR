...
# Open ports through the firewall for VPN and Micromine

sudo firewall-cmd --permanent --add-port=443/tcp
sudo firewall-cmd --permanent --add-port=943/tcp
sudo firewall-cmd --permanent --add-port=600/tcp
sudo firewall-cmd --permanent --add-port=2222/tcp
sudo firewall-cmd --permanent --add-port=1194/udp
sudo firewall-cmd --permanent --add-port=6200/udp
...
firefox https://github.com/rlabeangeo/NeWorldRes
firefox https://www.microsoft.com/en-us/software-download/windows10ISO
